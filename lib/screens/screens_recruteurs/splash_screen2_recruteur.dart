...
import 'splash_screen3_recruteur.dart';
import '../register_screen.dart';

class SplashScreen2Recruteur extends StatefulWidget {
  const SplashScreen2Recruteur({super.key});

  @override
  State<SplashScreen2Recruteur> createState() => _SplashScreen2RecruteurState();
}

class _SplashScreen2RecruteurState extends State<SplashScreen2Recruteur> with SingleTickerProviderStateMixin {
    ...
    Future.delayed(const Duration(seconds: 3), () {
      ...
      Navigator.of(context).pushReplacement(
        MaterialPageRoute(
          ...
          builder: (context) => const SplashScreen3Recruteur(), 
        ),
      );
    });
  }
            ...
            child: AnimatedBuilder(
              ...
              builder: (context, _) {
                return Transform.scale(
                  ...
                  child: Image.asset(
                     'assets/images/splash_screen2_recruteur.png',
                    fit: BoxFit.cover,
                  ),
                );
              },
                      ...
                      child: Padding(
                        ...
                        child: Align(
                          ...
                          child: SizedBox(
                            ...
                            child: Text(
                              'QUEL QUE SOIT VOTRE BESOIN, NOUS AVONS LE PROFIL POUR VOUS.',
