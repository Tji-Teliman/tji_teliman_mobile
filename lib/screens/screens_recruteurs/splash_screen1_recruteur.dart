...
import 'splash_screen2_recruteur.dart';
import '../register_screen.dart';

class SplashScreen1Recruteur extends StatefulWidget {
  const SplashScreen1Recruteur({super.key});

  @override
  State<SplashScreen1Recruteur> createState() => _SplashScreen1RecruteurState();
}

class _SplashScreen1RecruteurState extends State<SplashScreen1Recruteur> with SingleTickerProviderStateMixin {
    ...
    Future.delayed(const Duration(seconds: 3), () {
      ...
      Navigator.of(context).pushReplacement(
        MaterialPageRoute(
          ...
          builder: (context) => const SplashScreen2Recruteur(), 
        ),
      );
    });
  }
            ...
            child: AnimatedBuilder(
              ...
              builder: (context, _) {
                return Transform.scale(
                  ...
                  child: Image.asset(
                    'assets/images/splash_screen1_recruteur.png',
                    fit: BoxFit.cover,
                  ),
                );
              },
                      ...
                      child: Padding(
                        ...
                        child: Align(
                          ...
                          child: SizedBox(
                            ...
                            child: Text(
                              'LA PLATEFORME QUI MET FIN AU CHÔMAGE DES JEUNES ET SIMPLIFIE VOTRE QUOTIDIEN.',
