...
class SplashScreen4Recruteur extends StatefulWidget {
  ...
  @override
  State<SplashScreen4Recruteur> createState() => _SplashScreen4RecruteurState();
}

class _SplashScreen4RecruteurState extends State<SplashScreen4Recruteur> with SingleTickerProviderStateMixin {
    ...
    Future.delayed(const Duration(seconds: 3), () {
      ...
      Navigator.of(context).pushReplacement(
        MaterialPageRoute(
          ...
          builder: (context) => const SplashScreen1Recruteur(), 
        ),
      );
    });
  }
            ...
            child: AnimatedBuilder(
              ...
              builder: (context, _) {
                return Transform.scale(
                  ...
                  child: Image.asset(
                     'assets/images/splash_screen4_recruteur.png',
                    fit: BoxFit.cover,
                  ),
                );
              },
                          ...
                          child: ClipRRect(
                            ...
                            child: BackdropFilter(
                              ...
                              child: Container(
                                ...
                                child: Text(
                                  'SIMPLIFIEZ VOS RECRUTEMENTS ET GAGNEZ DU TEMPS.',
