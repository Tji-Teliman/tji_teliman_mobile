                    ...
                    Padding(
                      ...
                      child: Row(
                        children: [
                          ...
                          const SizedBox(width: 10), // Espace entre le champ et le bouton
                          // *** BOUTON AJOUTER (à droite du TextField) ***
                          SizedBox(
                            height: 48, // Ajustement de la hauteur pour correspondre au champ
                            child: ElevatedButton(
                              onPressed: _addSkill, // <-- C'est cette fonction qui ajoute la compétence
                              style: ElevatedButton.styleFrom(
                                backgroundColor: _primaryBlue.withOpacity(0.1), // Bleu très clair
